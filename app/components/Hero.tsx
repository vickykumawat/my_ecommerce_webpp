  ...
  return (
    <section className='hero_grid bg-home-bg bg-no-repeat bg-cover  bg-center text-white' >
     ...
     <SearchIcon styling="max-w-[80%] rounded-xl border border-yellow-500 search_flex  px-3 md:hidden"/>
      ...
      <div className='text-xl md:text-4xl lg:mt-20 lg:text-4xl lg:font-bold xl:text-5xl max-w-[60%] md:max-w-[50%] lg:max-w-[35%] mx-auto text-center '>
        <h1 className=''>Your one stop Mini Online store</h1>
      </div>
      <div className='mx-auto text-xs  max-w-[80%] md:max-w-[50%] lg:max-w-[30%] text-center mt-2 lg:mt-1'>
