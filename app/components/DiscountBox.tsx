...
function DiscountBox({}: Props) {
  return (
    <div className='max-w-[100%]  discount_holder grid place-items-center place-content-center bg-[#FEF1ED]'>
       <div className='flex flex-col rounded-lg gap-5 justify-center items-center min-w-[90%] discount_box text-center p-3 text-white'>
            ...
            <div className=' max-w-[90%] border bg-[#4B4B4B] m-5 flex justify-between p-1 rounded-xl relative'>
                ...
                <button className='bg-[#FF9774] px-3 text-xl  text-center discount_btn -mr-2'>suscribe</button>
            </div>
       </div>
    </div>
  )
